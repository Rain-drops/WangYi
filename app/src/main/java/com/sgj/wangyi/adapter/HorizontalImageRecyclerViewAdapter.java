...
//    }
    ...
    public HorizontalImageRecyclerViewAdapter(Context context, PhotoSet photoSet, RecyclerView recyclerView) {
        ...
        imageWeight = (int)(BaseApplication.width - (leftAndRightMargin + imageMargin) * 2) / 3;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ImageViewHolder(hold, imageWeight, imageHeight, recyclerView, viewType, new ImageViewHolder.IMyViewHolderClicks(){
            @Override
